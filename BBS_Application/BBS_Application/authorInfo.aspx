<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="authorInfo.aspx.cs" Inherits="BBS_Application.authorInfo" %>
    ...
    <div>
        ...
        <div class="headCss">
            <div class="head-content">
                <div class="hr">
                    <ul>
                    <li><a href="Default.aspx"><asp:Label ID="homePageLabel" runat="server" Text="首页"></asp:Label></a></li>
        ...
        <div class="datagridBox">
            <div class="datagrid">
                <h3>他的文章</h3><hr />
                <asp:Label ID="no_notice_Info" runat="server" Text="他还没有发表文章" Font-Size="Smaller" ForeColor="Red" Visible="false"></asp:Label>
                <asp:DataGrid Visible="true" ID="Blog_DataGrid" DataKeyField="NoticeId" runat="server" Height="247px" Width="980px" AutoGenerateColumns="false">
                    <Columns>
                        ...
                        <asp:BoundColumn HeaderText="文章标题" DataField="NoticeTitle">
                          <HeaderStyle HorizontalAlign="Center" BackColor="WhiteSmoke" Width="980px"/>
                            <ItemStyle HorizontalAlign="Center"/>
                        </asp:BoundColumn>
                    </Columns>
                </asp:DataGrid>
